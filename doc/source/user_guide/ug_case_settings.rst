...
.. csv-table:: **shortwave_nml namelist options**
   ...
   "``ki_p_ssl_mn_vis``", "real", "visible extinction coefficient (1/m) of pond ssl", "70.2"
   "``ki_p_int_mn_vis``", "real", "visible extinction coefficient (1/m) of ponded ice interior", "20.2"
