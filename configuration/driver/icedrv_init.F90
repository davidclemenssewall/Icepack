...
! author Elizabeth C. Hunke, LANL
      ...
      character (len=char_len) :: shortwave, albedo_type, conduct, fbot_xfer_type, &
         ...
         pndfrbd, pndhead, pndhyps, pndmacr
      ...
      namelist /ponds_nml/ &
        hs0,            dpscale,         frzpnd,                        &
        pndfrbd,        pndhyps,         pndhead,       pndmacr,        &
      ...
      call icepack_query_parameters(ustar_min_out=ustar_min, Cf_out=Cf, &
           ...
           pndfrbd_out=pndfrbd, pndhyps_out=pndhyps, &
           pndhead_out=pndhead, pndmacr_out=pndmacr, &
 ...
 1050    format (a30,2x,6a6)   ! character
      ...
      call icepack_init_parameters(ustar_min_in=ustar_min, Cf_in=Cf, &
           ...
           pndfrbd_in=pndfrbd, pndhyps_in=pndhyps, &
           pndhead_in=pndhead, pndmacr_in=pndmacr, &
